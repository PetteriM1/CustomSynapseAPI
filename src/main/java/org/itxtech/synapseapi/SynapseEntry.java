    ...
    public class Ticker implements Runnable {
        ...
        public void run() {
            ...
            while ((playerLoginPacket = playerLoginQueue.poll()) != null) {
                ...
                SynapsePlayerCreationEvent ev = new SynapsePlayerCreationEvent(synLibInterface, SynapsePlayer.class, SynapsePlayer.class, ThreadLocalRandom.current().nextLong(), address);
